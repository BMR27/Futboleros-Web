...
namespace Proyecto_V.Models
{
    ...
    public partial class programacion5Entities : DbContext
    {
        ...
        public virtual int SP_ACTUALIZAR_TORNEO(Nullable<int> iD_TORNEO, Nullable<System.DateTime> fECHA_INICIAL, Nullable<System.DateTime> fECHA_FINAL, string nOMBRE_TORNEO, Nullable<short> cANTIDAD_EQUIPOS)
        {
        ...
        public virtual int SP_REGISTRAR_EQUIPOS_A_TORNEOS(Nullable<int> iD_TORNEO, Nullable<int> iD_EQUIPO)
        {
            var iD_TORNEOParameter = iD_TORNEO.HasValue ?
                new ObjectParameter("ID_TORNEO", iD_TORNEO) :
                new ObjectParameter("ID_TORNEO", typeof(int));
        ...
        public virtual int FINALIZAR_TORNEO(Nullable<int> iD_TORNEO)
        {
            var iD_TORNEOParameter = iD_TORNEO.HasValue ?
                new ObjectParameter("ID_TORNEO", iD_TORNEO) :
                new ObjectParameter("ID_TORNEO", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("FINALIZAR_TORNEO", iD_TORNEOParameter);
        }
