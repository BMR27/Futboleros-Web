        ...
        protected void btn_actualizar_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < tbl_lista_torneos.Rows.Count; i++)
            {
                ...
                if (check.Checked == true)
                {
                    ...
                    _torneo.idConsecutivo_Torneo = Convert.ToInt32(tbl_lista_torneos.Rows[i].Cells[0].Text);
                    _torneo.IdUsuario = tbl_lista_torneos.Rows[i].Cells[1].Text;
                    _torneo.Fecha_Inicio = tbl_lista_torneos.Rows[i].Cells[2].Text;
                    _torneo.Fecha_Final = tbl_lista_torneos.Rows[i].Cells[3].Text;
                    _torneo.NombreTorneo = tbl_lista_torneos.Rows[i].Cells[4].Text;
                    _torneo.CantidadEquipos = tbl_lista_equipos.Rows[i].Cells[5].Text;
